...
export default function Home() {
  ...
  return (
    <div className="h-screen flex flex-col justify-start items-center bg-gradient-to-r from-yellow-400 via-red-500 z-0 to-pink-500">
      <Head>
      ...
      <main className="max-w-6xl flex flex-col flex-1 justify-around items-center w-4/5 bg-white">
        ...
        <label htmlFor="title" className="font-bold">
          ...
          <div>
          {movies?.value ? <h2>Search Results for "{movies.value}"</h2> : null }
          </div>
        </div>
